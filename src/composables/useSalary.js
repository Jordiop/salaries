...
export function useSalary() {
  ...
  function estimatePercentile(salary, d) {
    ...
    if (salary <= d.p25)
      return Math.round(10 + ((salary - d.p10) / (d.p25 - d.p10)) * 15);
    if (salary <= d.p50)
      return Math.round(25 + ((salary - d.p25) / (d.p50 - d.p25)) * 25);
    if (salary <= d.p75)
      return Math.round(50 + ((salary - d.p50) / (d.p75 - d.p50)) * 25);
    if (salary <= d.p90)
      return Math.round(75 + ((salary - d.p75) / (d.p90 - d.p75)) * 15);
    return Math.min(
      99,
      Math.round(90 + ((salary - d.p90) / (d.p90 * 0.5)) * 9),
    );
  }
  ...
  function buildMapData(sex, year) {
    const PROV_TO_CCAA = {
      ...
      "es-tf": "Canarias",
      "es-s": "Cantabria",
      "es-av": "Castilla y León",
      "es-bu": "Castilla y León",
      "es-le": "Castilla y León",
      "es-p": "Castilla y León",
      "es-sa": "Castilla y León",
      "es-sg": "Castilla y León",
      "es-so": "Castilla y León",
      "es-va": "Castilla y León",
      "es-za": "Castilla y León",
      ...
      "es-l": "Cataluña",
      "es-t": "Cataluña",
      "es-a": "Comunitat Valenciana",
      "es-cs": "Comunitat Valenciana",
      "es-v": "Comunitat Valenciana",
      "es-ba": "Extremadura",
      "es-cc": "Extremadura",
      "es-c": "Galicia",
      "es-lu": "Galicia",
  ...
  const YEARS = computed(() => {
    const y = [];
    for (let i = max_year; i >= min_year; i--) y.push(i);
    return y;
  });
